...
def remove_image_filenames(text_to_convert):
  """
  ...
  return filename_pattern.sub('', text_to_convert)

def remove_emojis(text_to_convert):
  """
  ...
  return emoji_pattern.sub(r'', text_to_convert)

def remove_paragraph_spaces(text_to_convert):
  """
  ...
  normalized_text = text_to_convert.replace('\r\n', '\n').replace('\r', '\n')
...
def split_text_into_chunks(text_to_convert, chunk_size=4000):
  """
